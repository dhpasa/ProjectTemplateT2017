...
import com.logictech.dwzq.core.util.security.MD5;
...
public final class StringUtils extends BaseUtils {
    ...
    public static boolean isHasSpace(String txt) {
        ...
        if (txt.contains(FWConstants.DBC_SPACE) || txt.contains(FWConstants.SBC_SPACE)) {
            return true;
        }
        return false;
    }
    ...
    public static String join(List list, String separator) {
        ...
        return join(list, separator, 0, list.size());
    }
