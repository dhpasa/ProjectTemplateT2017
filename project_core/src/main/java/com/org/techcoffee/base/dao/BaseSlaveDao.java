package com.org.techcoffee.base.dao;
...
import com.org.techcoffee.base.entity.BaseEntity;
import com.org.techcoffee.base.page.Pagination;
import com.org.techcoffee.base.page.PagingResult;

/**
 * @ClassName: BaseDao
 * @Description: 这里需要在spring-config里面配置数据元，有个数据源的操作。比如数据库读写分离
 */
public abstract class BaseSlaveDao extends SqlSessionDaoSupport {

    @Resource(name = "sqlSlaveSession")
