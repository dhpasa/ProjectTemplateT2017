...
public class SelectCountAndListByMapPlugin extends PluginAdapter {
	...
	public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
		...
		selectCountByMapElement.addElement(
				new TextElement(
				"select count(*) from  " + tableName + " <include refid=\"Base_Query_Map_Condition\" /> "
				));
		...
		for (IntrospectedColumn introspectedColumn : introspectedTable
			...
			_orderByStr.append(MyBatis3FormattingUtilities
		...
		selectListByMapElement.addElement(
				...
				+ "select <include refid=\"Base_Column_List\" /> from  " + tableName + " <include refid=\"Base_Query_Map_Condition\" /> "
